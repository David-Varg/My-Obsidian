...
- **Hermanos**: [[07. Representación de Enteros]], [[08. IEEE 754]], [[03. Stack vs. Heap (Control de Memoria Profunda)]], [[09. Modelos de Ejecución]], [[07. Abstracción]] (Relación con **06_SISTEMAS** para entender cómo se guardan físicamente).
...
- [ ] **Flashcard**: ¿Qué sucede con la memoria cuando una variable sale de su scope? ([[03. Stack vs. Heap (Control de Memoria Profunda)]]).
