...
> **Contexto IT**: Para un Ingeniero de Software, es el núcleo de las [[05. Estructuras de Control]] (`if/else`), el diseño de circuitos en [[04. Arquitectura de Computadoras]], la optimización de consultas en bases de datos y el análisis de [[15. Complejidad Algorítmica]].
...
**Ver más en:** [[07. Clean Code]] | [[15. Complejidad Algorítmica]]
...
| **Complejidad Temporal** | $O(2^n)$ para Tablas de Verdad (ver [[16. Notación Big-O]]) |
| **Prerequisitos**        | [[02. Binario y Lógica]] [[04. Operadores y Expresiones]]                                   |
| **MOC Padre**            | [[10_MOC Matemáticas]]                                      |

## 💡 Intuición
Es el arte de conectar puntos para ver si una idea es lógicamente sostenible y solida o débil y fácilmente influenciable. Sirve para que no te engañen y que no te engañes a ti mismo.

## 🔗 **Conexiones**
- **Entrada**: [[01. Matemática Discreta]] → Esta nota
- **Salida**: Esta nota → [[03. Lógica de Predicados]]
- **Hermanos**: [[02. Binario y Lógica]], [[04. Teoría de Conjuntos]], [[04. Arquitectura de Computadoras]] [[01. Matemática Discreta]] [[08. Matemática para Algoritmos]]

## 🧩 Preguntas típica de entrevista
- "¿Cómo simplificaría una condición `if (!(A && !B))` para que sea más legible?" (**Respuesta**: Aplicando De Morgan: `!A || B`).
- "¿Qué es un problema NP-Completo?" (**Respuesta**: En terminos sencillos, es un problema que cumple con 2 condiciones. La primera que es fácil de verificar si es correcta o no la solución asumiendo que alguien te da una combinación en concreto, la segunda es que es difícil de resolver directamente ya que no se conoce metodo para encontrar la solución rápidamente aparte de probar muchas combinaciones hasta que salga la correcta).
