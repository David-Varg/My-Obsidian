...
## 🎯 **Concepto Clave**
**Definición**: Formalmente, se dice que $f(n) = O(g(n))$ si existen constantes positivas $c$ y $n_0$ tales que $0 \le f(n) \le c \cdot g(n)$ para todo $n \ge n_0$. En términos de ingeniería, representa el **peor caso** (Worst-case Scenery), garantizando que el algoritmo nunca será más lento que dicha cota.
...
- **O(2ⁿ)**: Algorítmos muy mal diseñados, si tienes uno de este nivel: Cambialo. No sirven para nada salvo un problema con muy pocas soluciones.
- **O(n!)**: El peor tipo de Algoritmo, no sirven para nada en ningún sentido: Cambialo.
```
...
| Prerequisitos | [[08. Pensamiento Algorítmico]], [[08. Matemática para Algoritmos]] |
...
- **O(n²)**: Tienes que comparar cada baldosa con todas las demás para ver si combinan. Si hay 10 baldosas, haces 100 comparaciones.

## 🔗 **Conexiones**
- **Entrada**: [[15. Complejidad Algorítmica]] → Esta nota
- **Salida**: Esta nota → [[17. Algoritmos de Ordenamiento]]
- **Hermanos**: [[22. Recursión]], [[18. Algorítmos de Búsqueda]]
...
- **Hacer**: Identificar la complejidad de un script propio en la carpeta [[Laboratorio]].
